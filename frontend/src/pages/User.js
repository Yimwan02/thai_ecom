...
function User() {
  ...
  useEffect(() => {
    // 🔒 ถ้าไม่ได้ Login ให้เด้งกลับหน้าแรก
    if (!user) {
    ...
    <div style={{ backgroundColor: "#000033", minHeight: "100vh" }}>
      ...
      <div className="position-relative mb-5">
        <img 
          ...
          alt="Banner" 
          onError={(e) => e.target.src = "https://placehold.co/1200x450?text=Changsuek+Banner"}
        />
      </div>

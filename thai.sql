...
(1, 1, '2026-03-21 21:34:50', 1580, 'paid');
...
(8, 'เสื้อทีมชาติไทย 2024 (แดง)', 'red_2024.jpg', 1, 3, 990),
...
--
ALTER TABLE `product_size`
  MODIFY `product_size_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
